...
describe('RBAC async', function() {
    ...
    it('should throw error if roles[$i].inherits[$i2] is not a string', function(done) {
        (new RBAC(function(cb) {
            setImmediate(cb, null, {
                hello: {
                    can: ['hel'],
    ...
    it('should throw error if roles[$i].inherits[$i2] is not a defined role', function(done) {
        (new RBAC(function(cb) {
            setImmediate(cb, null, {
                hello: {
                    can: ['hel'],
